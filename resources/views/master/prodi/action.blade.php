        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group required row mb-2">
                    ...
                    <div class="col-sm-9">
                        <select id="jurusan_id" name="jurusan_id" class="form-control form-control-sm select2_combobox">
                ...
                <div class="form-group required row mb-2">
                    <label class="col-sm-3 control-label col-form-label">Kode Prodi</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="prodi_code" name="prodi_code" value="{{ isset($data->prodi_code) ? $data->prodi_code : '' }}"/>
                    </div>
                </div>
                <div class="form-group required row mb-2">
                    <label class="col-sm-3 control-label col-form-label">Nama Prodi</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="prodi_name" name="prodi_name" value="{{ isset($data->prodi_name) ? $data->prodi_name : '' }}"/>
                    </div>
                </div>
                <div class="form-group required row mb-2">
