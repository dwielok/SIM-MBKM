    ...
    <div class="modal-content">
        ...
        <div class="modal-body p-0">
            ...
            <div class="row">
                <div class="col-7">
                    <table class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                <th class="w-15 text-right">Status Surat Balasan</th>
                                <th class="w-1">:</th>
                                <td class="w-84">
                                    <div class="form-group required row mb-2">
                                        <div class="col-sm-10">
                                            <div class="icheck-success d-inline mr-3">
                                                <input type="radio" id="radioActive" name="status" value="1">
                                                <label for="radioActive">Diterima </label>
                                            </div>
                                            <div class="icheck-danger d-inline mr-3">
                                                <input type="radio" id="radioFailed" name="status" value="0">
                                    ...
                                    <div class="form-group required row mb-2">
                                        <div class="col-sm-10">
                                            ...
                                            <small class="text-muted">Catatan untuk Surat Balasan</small><br />
                                            <small class="text-muted">** Mohon Bapak/Ibu koordinator agar melakukan
                                                <b>validasi(pengecekan)</b> terhadap surat balasan yang disubmit oleh
                                                mahasiswa </small>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="border-0">
                                    <button type="button" class="btn btn-primary" id="simpan"
                                        data-idsurat_balasan="{{ $magang->surat_balasan->dokumen_magang_id }}">Simpan</button>
                                </td>
                ...
                <div class="col-5">
                    <embed src="{{ asset('assets/suratbalasan/' . $magang->surat_balasan->dokumen_magang_file) }}"
