                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-sm row text-sm mb-0">
                                        ...
                                        {{-- <div class="col-md-4">
                                            <select
                                                class="form-control form-control-sm w-100 filter_combobox filter_kategori">
                                                <option value="">- Semua -</option>
                ...
                "aoColumns": [{
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, row, meta) {
                            return (data) ? data.prodi_name : '~ ALL ~';
                        }
                    },
                    {
                        "mData": "berita_judul",
                    ...
                    },
                    {
                        ...
                        "mRender": function(data, type, row, meta) {
                            ...
                            @if ($allowAccess->read)
                                +
                                `<a href="#" data-block="body" data-url="{{ $page->url }}/${data}" class="ajax_modal btn btn-xs btn-info tooltips text-light" data-placement="left" data-original-title="Detail Data" ><i class="fa fa-list"></i></a> `
                            @endif
