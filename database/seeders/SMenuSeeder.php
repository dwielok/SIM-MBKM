...
class SMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('s_menu')->upsert([
            ...
            ['menu_id' => '12', 'menu_scope' => 'ALL', 'menu_code' => 'TRANSACTION.MAHASISWA', 'menu_name' => 'Mahasiswa', 'menu_url' => 'transaksi/mahasiswa', 'menu_level' => '2', 'order_no' => '2', 'parent_id' => '2', 'class_tag' => 'transaksi-mahasiswa', 'icon' => 'fas fa-minus text-xs', 'is_active' => '1'],
