...
class SMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('s_menu')->upsert([
            ...
            ['menu_id' => '9','menu_scope' => 'ADMIN','menu_code' => 'MASTER.MAHASISWA','menu_name' => 'Mahasiswa','menu_url' => 'master/mahasiswa','menu_level' => '2','order_no' => '25','parent_id' => '2','class_tag' => 'master-mahasiswa','icon' => 'fas fa-minus text-xs','is_active' => '1'],
            ['menu_id' => '10','menu_scope' => 'SUPER', 'menu_code' => 'SETTING.GROUP', 'menu_name' => 'Group', 'menu_url' => 'setting/group', 'menu_level' => '2', 'order_no' => '30', 'parent_id' => '5', 'class_tag' => 'setting-menu', 'icon' => 'fas fa-minus text-xs', 'is_active' => '1'],
            ['menu_id' => '11','menu_scope' => 'SUPER', 'menu_code' => 'SETTING.MENU', 'menu_name' => 'Menu', 'menu_url' => 'setting/menu', 'menu_level' => '2', 'order_no' => '31', 'parent_id' => '5', 'class_tag' => 'setting-menu', 'icon' => 'fas fa-minus text-xs', 'is_active' => '1'],
            ['menu_id' => '12','menu_scope' => 'SUPER', 'menu_code' => 'SETTING.USER', 'menu_name' => 'User', 'menu_url' => 'setting/user', 'menu_level' => '2', 'order_no' => '32', 'parent_id' => '5', 'class_tag' => 'setting-menu', 'icon' => 'fas fa-minus text-xs', 'is_active' => '1'],
